...
const hoverTargets = document.querySelectorAll(
  "a, button, .btn, .project-card, .srv-card, .social-icon, .cs-icon, .fs-icon, .contact-item, .abt-stat, .nav-toggle",
);
...
document
  .querySelectorAll(".abt-stat-num, .srv-stat-num")
  .forEach(function (el) {
...
document.querySelectorAll(".srv-card").forEach(function (card) {
  card.addEventListener("mousemove", function (e) {
    ...
    card.style.backgroundImage =
      "radial-gradient(circle 160px at " +
      x +
      "px " +
      y +
      "px, rgba(255,0,0,0.06), transparent 80%)";
  });
  card.addEventListener("mouseleave", function () {
    card.style.backgroundImage = "";
  });
